  ...
  programs = {
    atuin = {
      ...
      settings = {
        ...
        # Loop through terminal ignore list and anchor each to start and end of line.
        history_filter = map (cmd: "^${cmd}$") user.shell.history.ignore;
        search_mode = "fuzzy";
        # Determine if full command is shown at bottom of Atuin. Not really needed and kinda a waste of space.
        show_preview = false;
