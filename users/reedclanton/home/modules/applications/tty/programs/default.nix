...
in {
  ...
  let
    ...
    current-file-path = "user/${user.name}/home/modules/applications/tty/programs/default.nix";
    # Tracks location of global program(s).
    global-applications = "./../../../../../../../modules/home-manager/applications/tty/programs/default.nix";
  in validFiles ./. ++ [
    (
