...
in {
  ...
  let
    ...
    current-file-path = "user/${user.name}/home/modules/applications/gui/packages/default.nix";
    # Tracks location of global package(s).
    global-applications = "./../../../../../../../modules/home-manager/applications/gui/packages/default.nix";
  in validFiles ./. ++ [
    (
